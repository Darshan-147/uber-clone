...
const Home = () => {
  return (
    <div className="bg-cover bg-right-bottom bg-[url(https://www.asmag.com/upload/pic/case/55800.9755072.jpg)] bg-red-400 h-screen w-full pt-8 flex justify-between flex-col ">
